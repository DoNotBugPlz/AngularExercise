...
public class PkNubmerConfigTab {
    @Id
    @GeneratedValue(generator="config_data_id_gen")
    @GenericGenerator( name="config_data_id_gen", strategy="enhanced-table", //选用加强的table策略，需要在sessionfactory中配置属性hibernate.id.new_generator_mappings 为 true
            parameters = {
                    ...
                    @org.hibernate.annotations.Parameter( name = "segment_value", value = "config_data_id"),//序列名
