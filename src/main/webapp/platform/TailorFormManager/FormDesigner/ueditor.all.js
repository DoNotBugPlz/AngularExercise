                ...
                switch (align) {
                    ...
                    case 'center':
                        if (me.queryCommandValue('imagefloat') != 'center') {
                            ...
                            me.execCommand('insertHtml', '<p id="_img_parent_tmp"  style="text-align:center;margin: 0;padding: 0">' + pN.innerHTML + '</p>');
    ...
    execCommand:function (cmd, opt) {
        ...
        for (var i = 0, ci = opt[i]; i<opt.length;i++ ) {
            str = '<img border="0"  src="' + ci.src + '" ' + 
                ...
                //不做%转px，因为转了之后格式总是不准确
                 /* ' width :' + ci.width+ci.widthunit +';' +
                  ' height : ' +ci.height + ci.heightunit+ ';" />';*/
...
(function () {
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable', 'formattable'];
