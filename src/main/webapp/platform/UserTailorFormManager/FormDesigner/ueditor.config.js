    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'preview', 'source', '|', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'touppercase', 'tolowercase', 'spechars', 'horizontal','|',
                'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 
                'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
                'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
                'directionalityltr', 'directionalityrtl', 'indent', '|',
                'forecolor',  'fontfamily', 'fontsize', 'customstyle', 'paragraph','|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                'inserttable', 'formattable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'insertimage', 'searchreplace', 'help']
        ]
...
//        }
        ...
        ,focus:true //初始化时让编辑器获得焦点，默认为false

        //,autoClearEmptyNode : true //getContent时，是否删除空的inlineElement节点（包括嵌套的情况）

        //, fullscreen: false //初始化时开启全屏，默认为false
...
//        }()
        ...
        ,iframeUrlMap:{
            'insertimage': '~/dialogs/bindfield/TailorFormColFormat.htm'
         }
