...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'mergecells': '合并多个单元格', 'deletetable': '删除表格', 'cleardoc': '清空文档', 'insertparagraphbeforetable': "表格前插入行", 'insertcode': '代码语言', 'fontfamily': '字体', 'fontsize': '字号', 'paragraph': '段落格式', 'insertimage': '绑定字段', 'formattable': '格式化表格',
        ...
        'inserttable': '插入表格', 'formattable': '格式化表格'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
