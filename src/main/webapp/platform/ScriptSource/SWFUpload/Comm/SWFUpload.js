...
SWFUpload.completeURL = function (url) {
    ...
    if(str){
        var num = url.match(regx).length;
        for(var i=0;i<=num;i++){
            fullpath = fullpath.substring(0,fullpath.lastIndexOf("\/"));
        }
        var relativeUrl = fullpath +"/"+ url.replace(regx,"");
        return relativeUrl;
    }else{
        return url;
    }
...
SWFUpload.prototype.initSettings = function (userSettings) {
	...
	this.ensureDefault("flash_cab_url", "Swflash.cab");
	...
	if (!this.settings.preserve_relative_urls) {
	    ...
	    this.settings.flash_url = SWFUpload.completeURL(this.settings.flash_url);
	    this.settings.flash_cab_url = SWFUpload.completeURL(this.settings.flash_cab_url);
...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
    ...
    return ['<object id="', this.movieName, '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" type="application/x-shockwave-flash" codebase="../../ScriptSource/SWFUpload/Source/Swflash.cab#version=7,0,19,0" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
...
SWFUpload.prototype.displayDebugInfo = function () {
	this.debug(
		[
			...
			"\t", "flash_cab_url:            ", this.settings.flash_cab_url, "\n",
