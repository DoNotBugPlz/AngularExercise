...
(function ($) {
    ...
    function _233(_234) {
        ...
        if (_235.options.shadow == true) {
            _235.shadow = $("<div class=\"window-shadow\"><iframe frameborder=0 src='javascript:false' style=\"position:absolute;visibility:inherit;top:0px;left:0px;width:100%;height:100%;z-index:-1; filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)';\"</iframe></div>").insertAfter(_235.window);
    ...
    function _239(_23a) {
        ...
        _23b.window.draggable({ handle: ">div.panel-header>div.panel-title", disabled: _23b.options.draggable == false, onStartDrag: function (e) {
            ...
            var heightOfWindow = _23b.options.marginBottom ? $(window).height() - _23b.options.marginBottom : $(window).height();
            if (e.data.top < 0) {
                e.data.top = 0;
            }
...
(function ($) {
    ...
    function _264(_265, _266, _267,otherStyle) {
        var win = $("<div class=\"messager-body\" "+otherStyle+"></div>").appendTo("body");
        win.append(_266);
        if (_267) {
        ...
        var realTop = win.window("window").offset().top;
        var objHeight = win.window("window").height();
        var screenHeight = $(window).height();
        var top = (screenHeight-objHeight)/2;
        if(realTop>(top+10)||realTop<(top-10)){
            win.window("window").css('top',top);
    ...
    $.messager = { show: function (_269) {
        ...
        return win;
    }, confirm: function (_26d, msg, fn,otherStyle) {
        ...
        var win = _264(_26d, _26e, _26f,otherStyle);
        return win;
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, delay: 200, missingMessage: "此项不能为空.", invalidMessage: null, tipPosition: "right", deltaX: 0, novalidate: false,
        tipOptions: { showEvent: "none", hideEvent: "none", showDelay: 0, hideDelay: 0, zIndex: "",
            onShow: function () {
...
(function ($) {
    ...
    function _5dc(_5dd, _5de) {
        ...
        if (opts.pagination) {
            $.extend(_5df, { pageNumber: opts.pageNumber, pageSize: opts.pageSize });
        }
        if (opts.sortName) {
        ...
        for (var i = 0; i < _66b.length; i++) {
            ...
            if (col) {
                ...
                if (col.checkbox) {
                    ...
                    //上面一行代码修改为以下代码，zjb与2013-10-28修改，让datagrid可以默认选中checkbox
                    if (_66e.checked == "true") {
                        cc.push("<input type=\"checkbox\" checked=\"checked\"");
                    } else {
                        cc.push("<input type=\"checkbox\"");
                    }
                    cc.push(" name=\"" + _670 + "\" value=\"" + (_671 != undefined ? _671 : "") + "\">");
                } else {
                    if (col.formatter) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, { frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "正在处理，请稍后...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_695, _696) {
...
(function ($) {
    ...
    function _706(_725, _726, _727, _728, _729) {
        ...
        if (opts.pagination) {
            $.extend(_72a, { pageNumber: opts.pageNumber, pageSize: opts.pageSize });
        }
        if (opts.sortName) {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, { valueField: "value", textField: "text", groupField: null, groupFormatter: function (_84f) {
        ...
        return row[opts.textField].indexOf(q) >-1;//将从头位置匹配改为任意匹配 update by chenjian 20160114
...
(function ($) {
    function _891(_892) {
        ...
        function _895() {
            ...
            //自定义清空
            var _utdate=$("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>").html(opts.cleanText).appendTo(_898);
            _899.click(function () {
                _893.calendar.calendar({ year: new Date().getFullYear(), month: new Date().getMonth() + 1, current: new Date() });
            });
            //为添加的自定义清空，添加清空事件
            _utdate.click(function(){
...
//            });
    ...
    }, currentText: "今天", cleanText:"清空",closeText: "关闭", okText: "确定", formatter: function (date) {
...
$.extend($.fn.validatebox.defaults.rules, {
    length: {
        ...
        message: "请输入长度在{0}至{1}的字符串."
    },
    remote: {
        validator: function (_40c, _40d) {
            var options = _40d[0];
            var _40e = $.ajax({ url: options.url, dataType: "json", data: options.data, async: false, cache: false, type: "post" }).responseText;
            return _40e.toLowerCase() == "true";
        },
        message: "未能通过验证，请重新输入."
    },
    email: {
    ...
    english: {
        ...
        message: "请输入由英文字母或下划线组成的字符"
    },
    phone: {
        validator: function (value) {
            return /^\d{3,4}-?\d{7,9}$/.test(value);
        },
        message: "请正确填写您的电话号码(格式:XXXX-XXXXXXXX)"
    },
    zipcode: {
        validator: function (value, param) {
    ...
    loginname: {
        ...
        message: '登录名称只允许汉字、英文字母、数字及下划线、英文状态的短横线。'
    },
    safepass: {
        validator: function (value, param) {
    ...
    matchTime: {
        validator: function (value, param) {
            var comparValue = $('#' + param[0]).datetimebox('getValue');
            if (value != "" && comparValue != "") {
                if (param[1].toLowerCase() == "start") {
                    return value < comparValue;
                }
                else {
                    return value > comparValue;
                }
    ...
    matchDate: {
        validator: function (value, param) {
            var comparValue = $('#' + param[0]).datebox('getValue');
            if (value != "" && comparValue != "") {
                if (param[1].toLowerCase() == "start") {
                    return value <= comparValue;
                }
...
var idCard = function (value) {
    ...
    var d, sum = 0, v = '10x98765432', w = [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2], a =
...
var isDateTime = function (format, reObj) {
    ...
    var reVal = d.getFullYear() == o.yyyy && d.getMonth() + 1 == o.MM && d.getDate() == o.dd && d.getHours() == o.hh && d.getMinutes() == o.mm && d.getSeconds() == o.ss &&
