(function ($) {
    ...
    myflow.config = {
        ...
        path: {// 路径转换
            ...
            props: {
                id: { value: '' },
                startactivitymodelid: { value: '' },
                endactivitymodelid: { value: '' }
            }
        },
        tools: {// 工具栏
            attr: {
				    ...
				    switch (mod) {
				        case 'pointer': //选择
				            ...
				            if (nodeData && nodeData.type != "end") {
				                //debugger;
				                whichNode = nodeData;
				                addMdlAcitvityEditPages(nodeData.type);
				            }
				            else {
				                $("#editPanel").html("");
				            }
        ...
        */
            ...
            if (c) {
                ...
                if (c.getId().substring(0, 4) == 'rect') {
                    ...
                    GlobalTools.ajax({
                        async: false,
                        type: "POST",
                        url: rootPath + "Sys_mdl_activity/DeleteActivity.do",
                        data: { id: rectPathId },
                        beforeSend: function () {
                    ...
                    GlobalTools.ajax({
                        async: false,
                        type: "POST",
                        url: rootPath + "Sys_mdl_transition/DeletePath.do",
                        data: { id: rectPathId },
                        beforeSend: function () {
                            GlobalTools.showLoading("正在删除..........");
                        },
        ...
        $(_r).bind('addrect', function (e, type, o) {
            ...
            GlobalTools.ajax({
                cache: false,
                async: false,
                url: rootPath + "Sys_mdl_activity/SaveRectByDrop.do",
        ...
        var addpathHandler = function (e, from, to) {
            ...
            GlobalTools.ajax({
                cache: false,
                async: false,
                url: rootPath + "Sys_mdl_transition/SavePathByDrop.do",
                data: { processid: processid, text: pathData.text.value, startactivitymodelid: fromRect.props.id.value, endactivitymodelid: toRect.props.id.value },
                success: function (data) {
                    var tempPathStr = "";
                    var tempPathData;
                    var propsId;
        ...
        if (myflow.config.editable) {
            ...
            $('#myflow_save').unbind('click').bind('click', function () {// 保存
                ...
                $.ajax({
                    ...
                    async: false,
                    type: "POST",
                    url: rootPath + "Sys_mdl_process/SaveModelWorkFlowDesign.do",
