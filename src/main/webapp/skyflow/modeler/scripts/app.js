  ...
  .config(['$provide', '$routeProvider', '$selectProvider', '$translateProvider', function ($provide, $routeProvider, $selectProvider, $translateProvider) {
    ...
    $routeProvider
        ...
        */
        ...
        //     'en-*': 'en'
        // })
        // .useSanitizeValueStrategy('sanitizeParameters')  注释原因：该策略会对UTF-8或特殊字符重复编码，详见flowable-engine :issues#541
        .useSanitizeValueStrategy('escapeParameters')//该策略可以正常将国际化json文件中的参数转为对应的中文。
