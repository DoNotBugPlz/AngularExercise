...
(function () {
    ...
    angular
        ...
        .controller('AddMonitorIndicatorsController', AddMonitorIndicatorsController);
    AddMonitorIndicatorsController.$inject = ['$scope', 'coreService','addMonitorIndicatorsService','pageInfDefault', 'ngDialog', '_','$state'];

    /* @ngInject */
    function AddMonitorIndicatorsController($scope, coreService,addMonitorIndicatorsService,pageInfDefault, ngDialog, _,$state) {
        var vm = this;
        window.a = vm;
        vm.choosedGoods = [];
        vm.searchParams = {};
        ...
        vm.getIndexListByParam = getIndexListByParam;
        ...
        function getIndexListByParam(pageNumber,pageSize) {
            var pageInf = {
            ...
            addMonitorIndicatorsService.getIndexListByParam(params)
                .then(function (resp) {
        ...
        function setGoodsList(response,pageNum) {
            ...
            vm.goodsListPage = angular.extend({pageTurn: 'getIndexListByParam',pagenum:pageNum,pagesize:5}, result);
        }
