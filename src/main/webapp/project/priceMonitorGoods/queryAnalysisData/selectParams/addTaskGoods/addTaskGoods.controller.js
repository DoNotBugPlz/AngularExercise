...
(function () {
    ...
    angular
        ...
        .controller('AddMonitorGoodsServiceController', AddMonitorGoodsServiceController);
    AddMonitorGoodsServiceController.$inject = ['$scope', 'coreService','addMonitorGoodsService','pageInfDefault', 'ngDialog', '_','$state'];

    /* @ngInject */
    function AddMonitorGoodsServiceController($scope, coreService,addMonitorGoodsService,pageInfDefault, ngDialog, _,$state) {
        var vm = this;
        window.a = vm;
        vm.choosedGoods = [];
        vm.searchParams = {};
        ...
        function cancelOp() {
            ngDialog.close($scope.ngDialogId,11111111111111);
        }
