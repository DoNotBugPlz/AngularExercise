...
(function () {
    ...
    angular
        ...
        .controller('QuerymonitordatashareOtherShareCtrl', QuerymonitordatashareOtherShareCtrl);
    QuerymonitordatashareOtherShareCtrl.$inject = ['$scope', 'querymonitordatashareOtherShareService', 'pageInfDefault', 'ngDialog', '$sce', '$q', '_', '$window'];

    /* @ngInject */
    function QuerymonitordatashareOtherShareCtrl($scope, querymonitordatashareOtherShareService, pageInfDefault, ngDialog, $sce, $q, _, $window) {
        var os = this;
        window.os = os;
        ...
        function active() {
            $q.all([
                querymonitordatashareOtherShareService.loadOSList({})
            ]).then(loadOSSuccess);
        }
        ...
        function loadList(pageNumber, pageSize) {
            ...
            querymonitordatashareOtherShareService.loadOSList(params).then(loadOSListSuccess);
        }
        ...
        function addCollect(item) {
            ...
            querymonitordatashareOtherShareService.addCollect(params)
                .then(function () {
