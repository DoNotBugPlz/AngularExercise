...
(function () {
    ...
    TrainingDetailCtrl.$inject = ['localStorageService', '$scope', 'ngDialog', 'coreService', 'officeService'];

    /* @ngInject */
    function TrainingDetailCtrl(localStorageService, $scope, ngDialog, coreService, officeService) {
        var vm = this;
        var data_type = 2;
        vm.title = "TrainingDetailCtrl";
