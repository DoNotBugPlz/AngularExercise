                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            var template = setup.template,
                                locals = setup.locals;
				            var html = [];
                            html.push("<div class=\"popup_title\">\n" +
                                "            <span>"+options.title+"</span>\n" +
                                // "            <a class=\"popup_close\" href=\"javascript:;\"></a>\n" +
                                "");
                            if (options.showClose) {
                                html.push('<a aria-label="Dismiss" class="ngdialog-close"></a>');
                            }
                            html.push( "        </div>\n");
                            template = html.join("")+template;
                            ...
                            if (options.top) {
                                $dialogContent = $dialog[0].querySelector('.ngdialog-content');
                                $dialogContent.style.cssText += "bottom:auto!important";
                                if (angular.isString(options.top)) {
                                    $dialogContent.style.cssText += "top:"+top+"!important";
                                } else {
                                    $dialogContent.style.cssText += "top:"+top+"px!important";
                                }
                            }
