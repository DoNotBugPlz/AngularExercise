...
(function () {
    ...
    function GoodsReferenceLibCtrl($scope, coreService, goodsReferenceLibService, pageInfDefault, ngDialog, _,$state) {
        ...
        function goodsLink() {
            var params = {name:vm.goods_familyName,goodsfamilyid:vm.goods_familyValue};
            ngDialog.open({
                title: '商品关联管理',
                ...
                resolve: {
                    loadChangePwdFiles: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            ...
                            './goodsReferenceLib/standardGoodsReferenceLib/goodsLink/goodsLink.css',
                            'My97DatePicker'
                        ]);
                    }
                },
